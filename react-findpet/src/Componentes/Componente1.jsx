...
const Componente1 = () => {
  ...
  const [editarDue, setEditarDue] = useState("");
  const [editarTelefono, setEditarTelefono] = useState("");
  const [editarUltimaVezVisto, setEditarUltimaVezVisto] = useState("");
  const [nuevoNombre, setNuevoNombre] = useState("");
  const [nuevaDescripcion, setNuevaDescripcion] = useState("");
  const [nuevaRaza, setNuevaRaza] = useState("");
  const [nuevoDue, setNuevoDue] = useState("");
  const [nuevoTelefono, setNuevoTelefono] = useState("");
  const [nuevaUltimaVezVisto, setNuevaUltimaVezVisto] = useState("");
  ...
  const handleEditarPost = (postId, nombre, descripcion, raza, due, telefono, referencia) => {
    setEditarPostId(postId);
    setEditarNombre(nombre);
    setEditarDescripcion(descripcion);
    setEditarRaza(raza);
    setEditarDue(due);
    setEditarTelefono(telefono);
    setEditarUltimaVezVisto(referencia)
  };
  ...
  const handleActualizarPost = (postId) => {
    const post = {
      ...
      PetBreed: editarRaza,
      PetOwner: editarDue,
      PetPhone: editarTelefono,
      PetReference: editarUltimaVezVisto
    };
  ...
  const handleAgregarPost = async () => {
    const nuevoPost = {
      ...
      PetBreed: nuevaRaza,
      PetOwner: nuevoDue,
      PetPhone: nuevoTelefono,
      PetReference: nuevaUltimaVezVisto
    };
    if (
      nuevoNombre === "" ||
      nuevaDescripcion === "" ||
    ...
    <div>
            ...
            <tr key={perro.id}>
              ...
              <td>
                {editarPostId === perro.id ? (
                  <input
                    type="text"
                    value={editarDue}
                    onChange={(e) => setEditarDue(e.target.value)}
                  />
                ) : (
                  perro.PetOwner
                )}
              ...
              <td>
                {editarPostId === perro.id ? (
                  <input
                    type="text"
                    value={editarUltimaVezVisto}
                    onChange={(e) => setEditarUltimaVezVisto(e.target.value)}
                  />
                ) : (
                  perro.PetReference
                )}
              ...
              <td>
                {editarPostId === perro.id ? (
                  ...
                  <>
                    <button onClick={() => handleEditarPost(perro.id, perro.PetName, perro.PetDescription, perro.PetBreed, perro.PetOwner, perro.PetPhone, perro.PetReference)}>
                      Editar
                    </button>
     ...
     <h2>Agregar nuevo post:</h2>
      ...
      <input
          ...
          placeholder="Dueño"
          value={nuevoDue}
          onChange={(e) => setNuevoDue(e.target.value)}
      />
      <input
          type="text"
      ...
      <input
          ...
          value={nuevaUltimaVezVisto}
          onChange={(e) => setNuevaUltimaVezVisto(e.target.value)}
      />
